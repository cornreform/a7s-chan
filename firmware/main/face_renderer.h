...
private:
    ...
    void draw_eye_line(int fy, int cx, int cy, const expression_params_t& p, bool is_left);
    void draw_pupil(int px, int py, int fy);
    void draw_eyebrow_line(int fy, int cx, int cy, const expression_params_t& p, bool is_left);
    ...
    void draw_heart_eyes_line(int fy, int cx, int cy, const expression_params_t& p, bool is_left);
